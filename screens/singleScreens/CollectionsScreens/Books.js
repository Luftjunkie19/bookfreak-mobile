...
<Searchbar placeholderTextColor="white" placeholder={translations.searchInput.placeholderBooks[selectedLanguage]} elevation={12} iconColor='white' inputStyle={{color:"white", fontFamily:"OpenSans-Regular"}} style={{margin:6, backgroundColor:accColor}} />
